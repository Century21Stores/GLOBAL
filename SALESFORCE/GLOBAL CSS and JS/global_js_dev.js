// Global JS - JuanMa - GWP added - 1.16.19
...
// [START] DEV ONLY Swappping elements GA
function globalBannerSwap(){
  $('header').after(
    '<button class="dev-swap-button" onclick="doSwap()">Swap</button>'
  )
}globalBannerSwap();

function doSwap() {
    swapElements(document.querySelector(".header-banner"), document.querySelector(".header"));
}
...
// [END] DEV ONLY Swappping elements GA
